    ...
    public class ClientesController : ControllerBase
    {
        ...
        public async Task<ActionResult<APIResponse>> GetClients()
        {
            try
            {
                ...
                IEnumerable<BD_CLIENTES> ClientList = await _clientesRepo.GetAll();
                _response.Result = _mapper.Map<IEnumerable<BD_CLIENTES_DTO>>(ClientList);
        ...
        public async Task<ActionResult<BD_CLIENTES_DTO>> GetClient(int id)
        {
            try
            {
                ...
                _logger.LogInformation("Se obtuvo satisfactoriamente el cliente con el ID: " + id);
        ...
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> UpdateClient(int id, [FromBody] BD_CLIENTES_UPDATE_DTO clientUpdateDto)
        {
            try
            {
                ...
                BD_CLIENTES model = _mapper.Map<BD_CLIENTES>(clientUpdateDto);


                await _clientesRepo.Update(model);
